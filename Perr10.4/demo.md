...
| | |
|---|---|
| Код продукта | `sintaris-pl` — основной репозиторий: 1 778 коммитов, 14 выпусков, ветка `master`. Закрытый |
| Этот разбор | https://github.com/Sintaris-d-o-o/zerocoder/tree/main/Perr10.4 — открытый |

Разбор ссылается на код по путям и номерам строк, поэтому его можно проверить, имея доступ к
основному репозиторию, а без доступа — прочитать приведённые в нём фрагменты.
